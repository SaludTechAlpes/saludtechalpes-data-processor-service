...
class FormatoImagenValido(ReglaNegocio):
    ...
    def __init__(self, ruta_imagen_importada, mensaje="El formato de la imagen no es válido"):
        super().__init__(mensaje)
        self.ruta_imagen_importada = ruta_imagen_importada

    def es_valido(self) -> bool:
        return self.ruta_imagen_importada.endswith((".dicom", ".dcm"))